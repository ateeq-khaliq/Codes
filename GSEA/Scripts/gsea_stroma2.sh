## This Script runs fine on server, 
##i had created this for Stroma2 niches, make sure you are using the edited version of GSEA_DIR/gsea-cli.sh script for memory.
#!/bin/bash
...
GCT_FILE="$BASE_DIR/stroma2/stroma2_cc5_8_9.gct"
CLS_FILE="$BASE_DIR/stroma2/stroma2_cc5_8_9.cls"

# Set up output directory
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
OUTPUT_DIR="$BASE_DIR/stroma2/gsea_results_stroma2_NEW$TIMESTAMP"
mkdir -p "$OUTPUT_DIR"
...
collections=("h.all.v2024.1.Hs.symbols.gmt" 
             "c2.cp.biocarta.v2024.1.Hs.symbols.gmt" 
             "c2.cp.reactome.v2024.1.Hs.symbols.gmt" 
             "c2.cp.kegg_legacy.v2024.1.Hs.symbols.gmt"  # Corrected for KEGG
