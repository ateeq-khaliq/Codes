...
markers1 = pd.read_csv("/Users/akhaliq/Desktop/deniche/all/nicheDE_new/New/patient/marker_genes_new.xlsx",sep="\t",encoding= 'unicode_escape')
markers1.to_excel(outmark, sheet_name = "markers")


d={}
for i in open("/Users/akhaliq/Desktop/MarkerGenesListCode/markers.txt",encoding= 'unicode_escape'):
	line1=i.strip().split("\t")
	if len(line1) == 2:
		#w,code=line.split('\t')
		w=line1[0].upper()
