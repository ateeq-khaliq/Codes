...
markers1 = pd.read_csv("/Users/akhaliq/Desktop/MarkerGenesListCode/markers/myeloid_markers_quin_review.txt",sep="\t",encoding= 'unicode_escape')
markers1.to_excel(outmark, sheet_name = "markers")


d={}
for i in open("/Users/akhaliq/Desktop/MarkerGenesListCode/markers/myeloid_markers_quin_review.txt",encoding= 'unicode_escape'):
	line1=i.strip().split("\t")
	if len(line1) == 2:
		#w,code=line.split('\t')
		w=line1[0].upper()
